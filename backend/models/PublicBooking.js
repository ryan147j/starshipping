module.exports = function (sequelize, DataTypes) {
  var PublicBooking = sequelize.define('PublicBooking', {
    ...
    internal_cost: { type: DataTypes.DECIMAL(10, 2), allowNull: true },
    profit: { type: DataTypes.DECIMAL(10, 2), allowNull: true },
    status: { type: DataTypes.STRING, defaultValue: 'pending-price' }
  }, {
